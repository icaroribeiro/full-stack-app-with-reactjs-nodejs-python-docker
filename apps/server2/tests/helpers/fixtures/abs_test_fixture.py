...
# class AbsTestFixture(ITestFixture):
...
#     async def close_database_container(self) -> None:
#         try:
...
#     async def disable_database(self) -> None:
#         try:
#             await self.__db_service.disable_database()
#             print("Database deactivated successfully!")
#         except Exception as error:
#             message = "Database deactivation failed!"
#             print(message, error)
#             raise error
